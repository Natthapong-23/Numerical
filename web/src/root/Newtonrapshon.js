...
myChange(event){
 ...
 componentDidMount(){
  axios.get("http://192.168.99.100::7000/api/getNewtonrapshon").then(res=>{
...
<div
    ...
    <h2 style={{ color: "black", fontWeight: "bold" }}>Newtonrapshon</h2><br /><br />
    <h2>fx </h2><Input size="large" name= "fx" style={{ width: 400 ,}}></Input><br /><br />
    <h2>X</h2>
    <Input size="large" name="x" style={{ width: 400 }}></Input><br /><br />
    <br /><br />
   ...
   style={{ width: "50%", float: "inline-start", marginBlockStart: "2%" }}
                                id="output12"
                            ><br /><br /> 
                            <Table style={{ width: 800 }} columns={columns} dataSource={dataTable} pagination={{ pageSize: 10 }} >
                            </Table>
                            </div>
                        }
