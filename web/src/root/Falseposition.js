...
componentDidMount(){
  axios.get("http://192.168.99.100:7000/api/getFalseposition").then(res=>{
    ...
    return (
      <Layout style={{ minHeight: '100vh' }}>
                      <div
                          ...
                          <h2 style={{ color: "black", fontWeight: "bold" }}>False-Position</h2><br /><br />
                          ...
                          <Button onClick={() => this.componentDidMount()}
                              style={{  marginLeft: 90 ,color:'#000000',background:'#e6e600'}}>Data API</Button>
                        <br /><br />                                               
                      ...
                      {this.state.showOutput &&
                          <div
                              ...
                              id="output12"
                          >
                              <br /><br /> <Table style={{ width: 800 }} columns={columns} dataSource={data} pagination={{ pageSize: 10 }} >
